...
import { signInWithGoogle, signInWithMicrosoft, signInWithLinkedIn } from '@/lib/social-auth'
            ...
            <div>
              ...
              <div style={{ display:'flex', flexDirection:'column', gap:10, marginBottom:20 }}>
                {[
                  ...
                  { label:'Continue with Microsoft', icon: <svg width="18" height="18" viewBox="0 0 24 24"><path fill="#F25022" d="M1 1h10v10H1z"/><path fill="#7FBA00" d="M13 1h10v10H13z"/><path fill="#00A4EF" d="M1 13h10v10H1z"/><path fill="#FFB900" d="M13 13h10v10H13z"/></svg>, fn: signInWithMicrosoft },
