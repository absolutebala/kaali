            ...
            <tbody>
              {leads.map(l => (
                <tr key={l.id}>
                  ...
                  <td style={{ padding:'10px 13px', fontSize:12, color:'#9AAAC8', borderBottom:'0.5px solid rgba(255,255,255,.05)' }}>{l.email}</td>
                  ...
                  <td style={{ padding:'10px 13px', fontSize:12, color:'#9AAAC8', borderBottom:'0.5px solid rgba(255,255,255,.05)' }}>{l.tenants?.company||'—'}</td>
                  <td style={{ padding:'10px 13px', fontSize:12, color:'#9AAAC8', maxWidth:180, borderBottom:'0.5px solid rgba(255,255,255,.05)', overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap' }}>{l.summary||'—'}</td>
                  <td style={{ padding:'10px 13px', borderBottom:'0.5px solid rgba(255,255,255,.05)' }}>
                    <span style={{ fontSize:10.5, fontWeight:500, padding:'2px 9px', borderRadius:20,
                  ...
                  <td style={{ padding:'10px 13px', fontSize:11, color:'#7B8DB5', borderBottom:'0.5px solid rgba(255,255,255,.05)', whiteSpace:'nowrap' }}>{fmtDate(l.created_at)}</td>
                </tr>
              ))}
              {!leads.length && <tr><td colSpan={7}><div style={{ padding:36, textAlign:'center', color:'#9AAAC8', fontSize:13 }}>No leads yet</div></td></tr>}
            </tbody>
          </table>
        )}
      </div>
