...
export async function sendLeadAlert({ to, companyName, lead, summary, country, city, device }) {
  ...
  await transport.sendMail({
    from:    `"Absolute AIChat" <${process.env.EMAIL_FROM}>`,
    to,
      ...
      <div style="font-family:Arial,sans-serif;max-width:540px;margin:0 auto;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e2e8f0">
        ...
        <div style="padding:28px 32px">
          <table style="width:100%;border-collapse:collapse">
            ...
            ${lead.company ? `<tr><td style="padding:10px 0;border-bottom:1px solid #f1f5f9;color:#94a3b8;font-size:13px">Company</td>
                <td style="padding:10px 0;border-bottom:1px solid #f1f5f9;color:#0f172a">${lead.company}</td></tr>` : ''}
            ${lead.designation ? `<tr><td style="padding:10px 0;border-bottom:1px solid #f1f5f9;color:#94a3b8;font-size:13px">Role</td>
                <td style="padding:10px 0;border-bottom:1px solid #f1f5f9;color:#0f172a">${lead.designation}</td></tr>` : ''}
            ...
            ${device ? `<tr><td style="padding:10px 0;border-bottom:1px solid #f1f5f9;color:#94a3b8;font-size:13px">Device</td>
                <td style="padding:10px 0;border-bottom:1px solid #f1f5f9;color:#0f172a">💻 ${device}</td></tr>` : ''}
            ${summary ? `<tr><td style="padding:10px 0;color:#94a3b8;font-size:13px;vertical-align:top">Summary</td>
                <td style="padding:10px 0;color:#475569;font-size:13px;line-height:1.6">${summary}</td></tr>` : ''}
          </table>
        ...
        <div style="padding:16px 32px;background:#f8fafc;border-top:1px solid #e2e8f0">
          <p style="color:#94a3b8;font-size:12px;margin:0">
            Powered by <a href="https://aichat.absoluteapplabs.com" style="color:#94a3b8">Absolute AIChat</a>
          </p>
        </div>
      </div>
    `,
      ...
      <div style="font-family:Arial,sans-serif;max-width:540px;margin:0 auto;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e2e8f0">
        ...
        <div style="padding:28px 32px">
          <p style="color:#475569;margin-bottom:20px">
            ${isOver
              ? `Your workspace has reached its monthly message limit.`
              : `Your workspace has used <strong>${pct}%</strong> of its monthly messages.`
            }
          </p>
